...
Rails::Initializer.run do |config|
  ...
  config.action_controller.session = {
    ...
    :secret      => '52a62d454af442a8c18abbb2d6b308a8c143cdf2b55d4b7501763218f0b5380ede4ef57b796f77a9f1f0aa265b6074cafbb4e9ab65e932a40499a0fab85195c8'
  }
  ...
  # (create the session table with 'rake db:sessions:create')
   ...
   #"sanitized_allowed_tags" AND "sanitized_allowed_attributes"
